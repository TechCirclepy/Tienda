...
{!! Form::open(array('url'=>'tienda/empresa','method'=>'POST','autocomplete'=>'off','files'=>'true')) !!}
			...
			<div class="form-group">
				...
				<input type="password" name="password_confirmation" class="form-control" placeholder="Ingrese Contraseña" />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<textarea maxlength="200" name="descripcion" class="form-control" placeholder="Detalla brevemente tu empresa"></textarea>
			</div>
			<div class="form-group">
				<label for="Dirección">Dirección</label>
				<input type="text" name="direccion" class="form-control" maxlength="200" placeholder="Dirección de la empresa" />
			</div>
			<div class="form-group">
				<label for="Celular">Celular</label>
				<input type="phone" name="cel" maxlength="15" class="form-control" onkeypress="return permite(event, 'num')" placeholder="Celular" />
			</div>
			<div class="form-group">
