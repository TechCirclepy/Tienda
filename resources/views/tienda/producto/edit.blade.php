...
{!! Form::model($producto,['method'=>'PATCH','route'=>['producto.update',$producto->pro_id],'files'=>'true']) !!}
			...
			<div class="form-group">
				...
				<input type="text" name="pro_nom" class="form-control" value="{{$producto->pro_nom}}" />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="number" min="50" max="99999999" onkeypress="return permite(event, 'num')" name="pro_precio" class="form-control" value="{{$producto->pro_precio}}" />
			</div>
			<div class="form-group">
				...
				@else
					<input type="radio" name="pro_ofer_active" onclick="pro_oferta.disabled = false" value="1"> Si 
  					<input type="radio" name="pro_ofer_active" value="0" onclick="pro_oferta.disabled = true" checked> No<br>
				@endif
  			</div>
  			<div class="form-group">
				<label for="precio_oferta">Precio Oferta</label>
				@if ($producto->pro_ofer_active==1)
					<input type="number" min="50" max="99999999" onkeypress="return permite(event, 'num')" name="pro_oferta" class="form-control" value="{{$producto->pro_oferta}}" />
				@else
					<input type="number" min="50" max="99999999" onkeypress="return permite(event, 'num')" name="pro_oferta" disabled="disabled" class="form-control" value="{{$producto->pro_oferta}}" />
				@endif
			</div>
			<div class="form-group">
				<label for="imagen">Producto</label>
				<input type="file" name="pro_foto" class="form-control" value="{{$producto->pro_foto}}">
