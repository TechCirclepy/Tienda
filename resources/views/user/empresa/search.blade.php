{!! Form::open(array('url'=>'user/empresa/index','method'=>'GET','autocomplete'=>'off','role'=>'search')) !!}
...
<div class="input-group mb-3">
  ...
  <input type="text" name="searchText" value="{{$searchText}}" class="form-control" placeholder="¿En qué tienda estás interesad@?">
  <div class="input-group-prepend">
